...
def model_cheat_sheet() -> list[str]:
    return [
        ...
        "- agent_aggregate_status <aggregate_id> [--summary] : show leg-level progress for one broadcast/partial-broadcast aggregate you started. agent_wait_status summarizes all of your waits; this inspects one aggregate in depth. Use after a human prompt, watchdog wake, or suspected bridge issue; do not poll. Watchdog wake ids shown here are ephemeral/correlation-only.",
...
def probe_prompt(mode: str, probe_id: str, alias: str, peers: str) -> str:
    ...
    return (
        ...
        "  agent_aggregate_status <aggregate_id> [--summary]    - show leg-level status for one broadcast/partial broadcast you started; agent_wait_status is broad self-summary, this is one aggregate in depth. Do NOT poll.\n"
