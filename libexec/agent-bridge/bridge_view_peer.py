...
USEFUL_ANCHOR_TOKEN_RE = re.compile(
    ...
    r"\b(?:agent_send_peer|agent_view_peer|agent_alarm|agent_interrupt_peer|agent_cancel_message|agent_wait_status|agent_aggregate_status|bridge|python3|pytest|rg|git)\b)"
)
